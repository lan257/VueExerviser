...
export default {
  data(){
    return{
      imgUri:[
          '@/assets/2ba11ad9-fe7e-4977-8aea-9a878475ec41.png',
          '@/assets/2ba11ad9-fe7e-4977-8aea-9a878475ec41.png',
          '@/assets/2ba11ad9-fe7e-4977-8aea-9a878475ec41.png',
          '@/assets/2ba11ad9-fe7e-4977-8aea-9a878475ec41.png',
      ],
      title:['Browser web','Android']
    }
  },
  components:{
    // PlatForm,
...
<!--    <PlatForm :title="title[1]" :imgUri="imgUri" style="flex:1"></PlatForm><div style="flex:0.6"></div></div>-->
  </div>
</template>
